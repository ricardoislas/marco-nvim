-- WARNING: This file is intended for LSP general configuration only.
-- Language specific configurations are done via individual files on the
-- plugins/languages subfolder and imported at the bottom of this file
return {
  {
  ...
  -- WARNING: here we import languages configurations from plugins/languages folder
